export const timingProfiles = {
    ...
    'alprazolam': {
      ...
      specificAdvice: {
        ...
        duration: "Avoid alcohol and other depressants."
      }
    },
    ...
    'klonazepam': {
      ...
      safetyInfo: {
        ...
        duration: "Long-lasting effects. Stay in safe environment.",
    ...
    'mdma': {
      ...
      duration: { duration: 180, intensity: 'high' },
      total: 360, // 6 hours
      safetyInfo: {
        ...
        duration: "Continue hydration. Watch for overheating.",
      ...
      specificAdvice: {
        ...
        duration: "Cool down if dancing. Watch body temperature."
      }
    },
    ...
    'psilocybin': {
      ...
      duration: { duration: 180, intensity: 'moderate' },
      total: 360, // 6 hours
      safetyInfo: {
        onset: "Nausea common. Stay comfortable.",
        peak: "Strong effects. Remain in safe space.",
        duration: "Effects reducing. Stay grounded.",
    ...
    'ketamin': {
      onset: { duration: 5, intensity: 'high' },
      peak: { duration: 30, intensity: 'very high' },
      duration: { duration: 60, intensity: 'moderate' },
      total: 120, // 2 hours
      safetyInfo: {
        onset: "Find safe position. Effects come quick.",
        peak: "Strong dissociation. Stay seated/lying.",
        duration: "Coordination impaired. Don't move much.",
    ...
    'dxm': {
      ...
      safetyInfo: {
        ...
        duration: "Significant impairment. Don't move around.",
    ...
    'morfin': {
      ...
      safetyInfo: {
        ...
        duration: "Avoid other depressants completely.",
    ...
    'oxycodone': {
      ...
      safetyInfo: {
        ...
        peak: "Strong effects. No additional doses.",
        duration: "Maintain safe position. No mixing.",
    ...
    '2cb': {
      ...
      safetyInfo: {
        ...
        duration: "Stay hydrated. Watch temperature.",
    ...
    'default': {
      ...
      safetyInfo: {
        ...
        duration: "Main effects continuing.",
  ...
  export const categoryProfiles = {
    ...
    'Sentralstimulerende': {
      ...
      safetyInfo: {
        ...
        duration: "Stay cool. Keep hydrating.",
    ...
    'Opioider': {
      ...
      safetyInfo: {
        ...
        duration: "Monitor breathing. No other depressants.",
